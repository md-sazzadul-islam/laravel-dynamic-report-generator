...
@section('content')
    <div class="container">
        ...
        <form id="report-form" method="POST" action="{{ url('/report-generator/reports/' . $report->id) }}">
            @csrf
            @method('PUT')
            <div class="row">
                        ...
                        <div>
                            <div class="pull-left" style="width: 87%">
                                <input readonly type="text" id="select_columns" name="select_columns"
                                    class="form-control" value="{{ $report_data_set->select_columns }}" required>
                            </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <input readonly type="text" id="main_table" name="main_table" class="form-control"
                            value="{{ $report_data_set->main_table }}" required>
                    </div>
                </div>
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <div>
                            <div class="pull-left" style="width: 90%">
                                <input readonly type="text" id="joined_tables" name="joined_tables" class="form-control"
                                    value="{{ $report_data_set->joined_tables }}">
                            </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea readonly id="query" name="query" class="form-control" rows="5" required>{{ $report->query }}</textarea>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="panel">
                    <h4>Table list (First click on table)</h4>
                ...
                .then(data => {
                    ...
                    $('#joined_tables').droppable({
                        ...
                        drop: function(event, ui) {
                            ...
                            let currentColumns = $('#joined_tables').val().split(',').map(col => col.trim())
                                .filter(col => col);
